                            ...
                            <form role="form" wire:submit.prevent="update">
                                ...
                                <div class="row">
                                    ...
                                    <!-- text input -->
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="data.birthDate" type="text" name="birthDate" id="birthDateInput" class="form-control @error('birthDate') is-invalid @enderror" placeholder="day-month-year"/>
                                            @error('birthDate')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <!-- text input -->
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="data.commencementDate" type="text" class="form-control @error('commencementDate') is-invalid @enderror" id="commencementDateInput" placeholder="day-month-year"/>
                                ...
                                <div class="row">
                                    ...
                                    <!-- text input -->
                                        <div class="form-group">
                                            <label>Ending</label>
                                            <input wire:model.defer="data.endDate" type="text" class="form-control @error('endDate') is-invalid @enderror" id="endingDateInput" placeholder="day-month-year"/>
                                            @error('endDate')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
